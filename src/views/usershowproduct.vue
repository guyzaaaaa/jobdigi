<template>
    <div>
      ...
      <div>
    <!-- Include NavbarUser component -->
    <NavbarUser />

    <!-- Existing content of your page -->
    <!-- Header Image with Search -->
    <div class="relative">
      <!-- Remaining content of your page -->
    </div>
  </div>
      <div class="relative">
  ...
  <div v-if="selectedPost" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
    <div class="bg-white p-8 rounded-lg animate-fade-down w-150 h-150 overflow-y-auto flex flex-col justify-between">
